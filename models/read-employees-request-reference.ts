 ...
 * 
 * @export
 * @interface ReadEmployeesRequestReference
 */
export interface ReadEmployeesRequestReference {
    /**
     ...
     * @type {Array<string>}
     * @memberof ReadEmployeesRequestReference
     */
    'fields'?: Array<string>;
    /**
     * Optional list of filters for filtering employees. We currently support up to one filter.
     * @type {Array<EmployeeFilter>}
     * @memberof ReadEmployeesRequestReference
     */
    'filters'?: Array<EmployeeFilter>;
    /**
